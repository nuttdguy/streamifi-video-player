        ...
        return (
            <div className={styles.backgroundFooter } >
                ...
                <div className={styles.childDescription }>
                    <p className={styles.title}>Fortnite Ghost Cup :D | Please be social distancing and extra hygenic 3
                    ...
                    <p className={styles.subtitle}> FortniteFortnite <span className={styles.audience}>Teen-Rated Stream</span></p>
                </div>
